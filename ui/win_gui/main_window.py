...
class IGEDGUI:
    ...
    def create_main_tab(self):
        ...
        # Command input
        tk.Label(input_frame, text="Enter Command:", bg="#2b2b2b", fg="#ffffff").pack(
            anchor=tk.W
        )

        self.command_entry = tk.Entry(
            input_frame, font=("Arial", 12), bg="#3b3b3b", fg="#ffffff"
        )
        ...
        # Output label
        tk.Label(output_frame, text="Output:", bg="#2b2b2b", fg="#ffffff").pack(
            anchor=tk.W
        )

        # Output text area
        self.output_text = scrolledtext.ScrolledText(
            output_frame, height=20, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 10)
        )
    ...
    def create_memory_tab(self):
        ...
        tk.Label(search_frame, text="Search Memory:", bg="#2b2b2b", fg="#ffffff").pack(
            side=tk.LEFT
        )
        ...
        tk.Label(
            details_frame, text="Memory Details:", bg="#2b2b2b", fg="#ffffff"
        ).pack(anchor=tk.W)

        self.memory_details = scrolledtext.ScrolledText(
            details_frame, height=10, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 9)
        )
    ...
    def create_status_tab(self):
        ...
        self.system_info = scrolledtext.ScrolledText(
            info_frame, height=8, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 9)
        )
        ...
        self.agents_info = scrolledtext.ScrolledText(
            agents_frame, height=6, bg="#1e1e1e", fg="#00ff00", font=("Consolas", 9)
        )
    ...
    def create_settings_tab(self):
        ...
        tk.Label(
            voice_frame, text="Voice Sensitivity:", bg="#2b2b2b", fg="#ffffff"
        ).pack(anchor=tk.W)
        self.voice_sensitivity = tk.Scale(
            voice_frame,
            from_=0.1,
            to=1.0,
            resolution=0.1,
            ...
            if "memory" in self.components:
                ...
                for entry in entries:
                    ...
                    self.memory_tree.insert(
                        "", "end", values=(timestamp, command, agent, success)
                    )
