            ...
            if self.operation == "authenticate":
                ...
                if success:
                    ...
                    self.authentication_complete.emit(
                        False, "Authentication failed or canceled"
                    )
                ...
                if available:
                    self.authentication_complete.emit(
                        True, "Biometric hardware available"
                    )
                else:
                    self.authentication_complete.emit(
                        False, "No biometric hardware available"
                    )
...
class BiometricManagerGUI(QMainWindow):
    ...
    def create_biometric_tab(self):
        ...
        self.auto_launch_checkbox = QCheckBox(
            "Auto-launch IGED after successful authentication"
        )
    ...
    def load_settings(self):
        ...
        self.auto_launch_checkbox.setChecked(
            self.settings.value("auto_launch", True, type=bool)
        )
        self.remember_reason_checkbox.setChecked(
            self.settings.value("remember_reason", True, type=bool)
        )
    ...
    def save_settings(self):
        ...
        self.settings.setValue(
            "remember_reason", self.remember_reason_checkbox.isChecked()
        )
